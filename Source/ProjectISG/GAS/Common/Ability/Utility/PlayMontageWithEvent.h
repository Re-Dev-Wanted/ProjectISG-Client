...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnPlayMontageWithEventNotified, FGameplayTag, EventTag, FGameplayEventData, EventData);

UCLASS()
class PROJECTISG_API UPlayMontageWithEvent : public UAbilityTask
{
	GENERATED_BODY()
